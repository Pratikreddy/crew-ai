...
task1 = Task(
    description="Search the internet and a list of promising real estate investment suburbs in Bangalore, INDIA. For each suburb highlighting the mean, low and max prices as well as the rental yield and any potential factors that would be useful to know for that area.",
...
writer = Agent(
    ...
    backstory="You are a real estate agent, your goal is to compile property analytics into a report for potential investors. list max output always",
    allow_delegation=False,
    verbose=True,
)
